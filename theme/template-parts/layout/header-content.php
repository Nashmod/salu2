				...
				<div class="flex items-center space-x-4">
					<div class="hidden md:ml-6 md:flex md:space-x-8">
						...
						<?php wp_nav_menu([
							...
							"container" => "",
							"items_wrap" => '%3$s',
							"link_class" => "inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700",
