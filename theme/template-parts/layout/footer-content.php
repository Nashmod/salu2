...
<footer class="bg-white" aria-labelledby="footer-heading">
	...
	<div class="mx-auto max-w-7xl px-6 pb-8 lg:px-8">
		<div class="md:grid md:grid-cols-5 md:gap-8 pt-20">
			<div></div>
			<div>
				<?php if (is_active_sidebar('footer-one')) : ?>
					<aside role="complementary" aria-label="<?php esc_attr_e('Footer one', 'westpuntcarrental'); ?>">
			...
			<div class="mt-10 md:mt-0">
				<?php if (is_active_sidebar('footer-two')) : ?>
					<aside role="complementary" aria-label="<?php esc_attr_e('Footer two', 'westpuntcarrental'); ?>">
			...
			<div class="col-span-1">
				<?php if (is_active_sidebar('footer-three')) : ?>
					<aside role="complementary" aria-label="<?php esc_attr_e('Footer three', 'westpuntcarrental'); ?>">
			...
			<div class="col-span-1 mt-10 md:mt-0">
				<?php if (is_active_sidebar('footer-four')) : ?>
					<aside role="complementary" aria-label="<?php esc_attr_e('Footer four', 'westpuntcarrental'); ?>">
		...
		<div class="mt-16 border-t border-gray-900/10 xl:grid xl:grid-cols-6 xl:gap-8 pt-8 text-right">
			...
			<div class="mt-16 grid grid-cols-1 gap-8 xl:col-span-4 xl:mt-0">
				<div class="md:grid md:grid-cols-4 md:gap-8 text-right">
					<?php wp_nav_menu([
						"theme_location" => "menu-footer",
						"menu_id" => "footer-menu",
						"container" => "",
						"items_wrap" => '%3$s',
						"link_class" => "text-[0.75rem] font-semibold leading-6 text-gray-900",
