...
<footer class="bg-white" aria-labelledby="footer-heading">
	...
	<div class="mx-auto max-w-7xl px-6 pb-8 lg:px-8 ml-auto">
		<div class="footer__grid md:grid md:grid-cols-5 md:gap-8 pt-20">
			<div></div>
			<div class="mt-10 md:mt-0 ml-auto">
			...
			<div class="col-span-1 mt-10 md:mt-0 ml-auto">
		...
		<div class="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
			<div class="flex space-x-6 md:order-2">
				<p class="text-[0.75rem] leading-6 text-gray-900">Privacy Policy</p>
				<p class="text-[0.75rem] leading-6 text-gray-900">Cookie Notice</p>
			</div>
