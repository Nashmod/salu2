...
<footer class="bg-white" aria-labelledby="footer-heading">
	...
	<div class="mx-auto max-w-7xl px-6 pb-8 lg:px-8">
		...
		<div class="border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
			...
			<div class="footer__menu pt-5 md:pt-0">
				<?php wp_nav_menu([
					"theme_location" => "menu-footer",
					"menu_id" => "footer-menu",
					"container" => "",
					"items_wrap" => '%3$s',
					"link_class" => "inline-flex uppercase items-center border-b-2 border-transparent pr-5 md:px-5 pt-1 text-sm font-medium text-gray-500",
